...
namespace Com.AiricLenz.XTB.Plugin
{
	...
	public partial class SettingsForm : Form
	{
		...
		{
			Settings.ShowFriendlyTableNames = flipSwitch_showFriendlyNames.IsOn;
			...
			Settings.ShowLogicalTableNames = true;
		...
		{
			Settings.ShowLogicalTableNames = flipSwitch_showLogicalNames.IsOn;
			...
			Settings.ShowFriendlyTableNames = true;
		...
		private void UpdateForm()
		{
			...
			flipSwitch_showFriendlyNames.IsOn = Settings.ShowFriendlyTableNames;
			flipSwitch_showLogicalNames.IsOn = Settings.ShowLogicalTableNames;
		}
